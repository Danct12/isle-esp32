...
/*
 * Save files and configuration will be stored on SPI Flash
 * While game files will be loaded from the SD Card
 */
#define DATA_PATH BSP_SD_MOUNT_POINT "/"
#define CFG_PATH BSP_SD_MOUNT_POINT "/cfgpath/"
